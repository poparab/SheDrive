...
| **A designer** | [`DESIGNER.md`](DESIGNER.md) — 10 screens, states, tone, prototype URLs |
...
- [**SheDrive Finance Story Map**](https://claude.ai/code/artifact/add3ef30-5b1e-465a-9391-ef646507b223)
  — all 30 work items: scope, team, origin and live ADO status, grouped by what each one
...
- [**SheDrive Money Rulebook**](https://claude.ai/code/artifact/5ff1415a-761d-4951-b349-09773fd8203f)
  ...
  it, plus a table of all 30 stories. Source: [`financial-logic-map.html`](financial-logic-map.html)
...
| File | Contents |
|---|---|
| `docs/backlog/api-stories.md` | 5 new API stories + #1764 and #1781 reopened and rewritten (7 total) |
| `docs/backlog/admin-stories.md` | 3 new admin stories + #1813 reopened, #1832 and #1833 extended (6 total) |
| `docs/backlog/mobile-driver-stories.md` | 3 new + #1788 rescoped onto the ledger (4 total) |
| `docs/backlog/mobile-rider-stories.md` | 3 new rider stories |
...
**Rider** — `payments.html` (rewritten from a stub), a dismissible outstanding-fee banner on
...
and recover nothing. Instead she simply clears her **entire** outstanding balance on her
next completed trip, always — one rule, no threshold and nothing to configure. Abuse is
...
2. **Deliberately deferred, worth re-confirming rather than inheriting:** surge pricing,
