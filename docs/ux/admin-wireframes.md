...
| 3 | **#1808 cancel trip / #1809 reassign trip are unwritten.** #1671 Scenario 5 requires both on the trip-detail screen; neither exists as an `[Admin]` story. Rendered disabled with a note. | Open — stories needed |
