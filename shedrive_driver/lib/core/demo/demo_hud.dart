            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  title: const Text('Logout & Clear Data'),
                  onTap: () async {
                    await Prefs.clear();
                ...
                ListTile(
                  ...
                  title: const Text('Simulate Incoming Request', style: TextStyle(fontWeight: FontWeight.bold)),
                  onTap: () {
                    Navigator.of(context).pop();
                    // Just a placeholder print for now
