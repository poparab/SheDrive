...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Welcome to SheDrive, Captain!'**
  String get welcomeGreeting;

  /// No description provided for @yourSafeJourney.
  ///
  /// In en, this message translates to:
  /// **'Your safe journey starts here.'**
  String get yourSafeJourney;
  ...
  /// No description provided for @safeTrusted.
  ///
  /// In en, this message translates to:
  /// **'Safe, Trusted, For Women'**
  String get safeTrusted;
  ...
  ///
  /// In en, this message translates to:
  /// **'24/7 Security Support for Women'**
